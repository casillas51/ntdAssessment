...
public class OperationServiceTest implements ApplicationTest {
    ...
    void whenPerformOperationBalance_thenPerformOperation() {
        ...
        OperationResultResponse result = operationService.performOperationBalance(1, OperationTypeEnum.ADDITION);
    ...
    void whenPerformOperationBalanceWithInvalidOperationType_thenThrowException() {
        ...
        assertThrows(OperationTypeNotFoundException.class, () -> operationService.performOperationBalance(1, OperationTypeEnum.ADDITION));
    }
