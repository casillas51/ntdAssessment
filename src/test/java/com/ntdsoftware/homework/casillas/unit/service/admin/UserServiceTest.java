...
public class UserServiceTest implements ApplicationTest {
     ...
     */
    @Test
    void whenCreateUser_thenReturnUserResponse() {
    ...
    void whenGetUserByIdWithExistingUserId_thenReturnUserResponse() {
        ...
        assertUserResponse(userService.getUserById(100));
    }
     ...
     */
    @Test
    void whenUpdateUserRoleAdminWithExistingUserId_thenReturnUserResponse() {
     ...
     */
    @Test
    void whenUpdateUserRoleUserWithExistingUserId_thenReturnUserResponse() {
     ...
     */
    @Test
    void whenUpdateUserWithInvalidUsername_thenThrowException() {
     ...
     */
    @Test
    void whenUpdateUserWithUniqueAdminRole_thenThrowException() {
     ...
     */
    @Test
    void whenDeleteExistingUserWithRoleUSer_thenDoNothing() {
